...
import avaliacao2evolutiva.main.PesquisaIbgeNomes;
import avaliacao2evolutiva.main.SugestionProblem;
import avaliacao2evolutiva.main.SugestionSolutionType;
...
public class XSuggestion {
	 ...
	 * @param solution
	 */
	public XSuggestion(Solution solution) {
		this() ;
	 ...
	 * @throws JMException
	 */
	public PesquisaIbgeNomes getValue(int index) throws JMException {
		return SugestionProblem.records.get(index);
	}
